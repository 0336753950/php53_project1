...
<div class="navi">
      <div class="navi-left">
        <ol>
          ...
          <li>
              <a class="active" href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>"><?php echo $this->getCategory($category_id); ?></a>
          </li>
        </ol>
      </div>
...
<div class="row">
      <div class="main-pad clearfix">
          <div class="container">
            
              <div class="title">
                <h1><a href="#"><?php echo $this->getCategory($category_id); ?></a></h1>
              </div>
                      ...
                      <li>
                          <div class="clearfix" style="position: relative;">
                            ...
                            <div class="heart" style="position: absolute;z-index: 1;padding: 5px;color: white;right: 0px;border: 1px solid red;background: red;width: 50%;height: 30px;">
                              ...
                              <figure><a href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>"><img src="assets/upload/products/<?php echo $rows->photo; ?>" title="<?php echo $rows->name; ?>" alt="<?php echo $rows->name; ?>"></a></figure>
                                ...
                                <div class="clearfix purchase">
                                  <a href="index.php?controller=cart&action=create&id=<?php echo $rows->id; ?>"><b style="color: white;">Mua hàng</b></a>
                                  <a href="#"><i class="fa fa-cart-wishlist"></i></a>
                                </div>
