<?php 
 ...
 ?>
 <div class="head-title head-title-xyz clearfix"><h1>Sản phẩm yêu thích</h1></div>
 	<div class="heading-counter">
        <div class="template-cart">
              <table class="table table-cart">
                <thead>
                  <tr>
                    <th class="image" style="width: 100px;">Ảnh sản phẩm</th>
                ...
                <?php foreach($_SESSION["Wishlist"] as $product): ?>
                  <tr>
                    <td><img style="width: 50px;" src="assets/upload/products/<?php echo $product['photo']; ?>" class="img-responsive" /></td>
