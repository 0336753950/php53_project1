...
<div class="col-md-12">  
    <div class="card">
        <div class="card-header"><strong>Add edit products</strong></div>
        <div class="card-body">
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo $action; ?>">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="text" value="<?php echo isset($record->price)?$record->price: 0; ?>" name="price" class="form-control" required>
                </div>
            </div>
            <!-- end rows -->  
            <!-- rows -->
