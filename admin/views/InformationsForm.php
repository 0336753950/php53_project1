...
<div class="col-md-12">  
    <div class="card">
        <div class="card-header"><strong>Add edit informations</strong></div>
        <div class="card-body">
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo $action; ?>">
            ...
            <!-- end rows -->
            <?php if(isset($record->photo)&&file_exists("../assets/upload/informations/".$record->photo)): ?>
            <!-- rows -->
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2"></div>
                <div class="col-md-10">
                    <img src="../assets/upload/informations/<?php echo $record->photo ?>" style="width: 100px;">
                </div>
            </div>
            <!-- end rows -->
            <?php endif; ?>
